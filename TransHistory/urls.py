...
urlpatterns = [
    ...
    path("api/add_node/", submit.post, name="post"),
    ...
    path('api/update_node/<int:pk>/', node.update_node, name='update_node_api'),
    path('api/delete_node/<int:pk>/', node.delete_node, name='delete_node_api'),
    ...
    path("nodemanage/", views.nodemanage, name="nodemanage"),
